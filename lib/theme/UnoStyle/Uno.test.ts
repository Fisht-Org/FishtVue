...
describe("unoStyle", () => {
  ...
  describe("Spacing", () => {
    ...
    // describe("min-width and min-height", () => {
    //   it.each<{ classValue: string; expected: string }>([
    //     {
    //       classValue: "space-x-0",
    //       expected:
    //         ".space-x-0{\n  --tw-space-x-reverse: 0;\n  margin-right: calc(0px * var(--tw-space-x-reverse));\n  margin-left: calc(0px * calc(1 - var(--tw-space-x-reverse)));\n}"
    //     },
    //     {
    //       classValue: "space-y-0",
    //       expected:
    //         ".space-y-0{\n  --tw-space-y-reverse: 0;\n  margin-top: calc(0px * calc(1 - var(--tw-space-y-reverse)));\n  margin-bottom: calc(0px * var(--tw-space-y-reverse));\n}"
    //     },
    //     {
    //       classValue: "space-x-0.5",
    //       expected:
    //         ".space-x-0.5{\n  --tw-space-x-reverse: 0;\n  margin-right: calc(2px * var(--tw-space-x-reverse));\n  margin-left: calc(2px * calc(1 - var(--tw-space-x-reverse)));\n}"
    //     },
    //     {
    //       classValue: "space-y-0.5",
    //       expected:
    //         ".space-y-0.5{\n  --tw-space-y-reverse: 0;\n  margin-top: calc(2px * calc(1 - var(--tw-space-y-reverse)));\n  margin-bottom: calc(2px * var(--tw-space-y-reverse));\n}"
    //     },
    //     {
    //       classValue: "space-x-1",
    //       expected:
    //         ".space-x-1{\n  --tw-space-x-reverse: 0;\n  margin-right: calc(4px * var(--tw-space-x-reverse));\n  margin-left: calc(4px * calc(1 - var(--tw-space-x-reverse)));\n}"
    //     },
    //     {
    //       classValue: "space-y-1",
    //       expected:
    //         ".space-y-1{\n  --tw-space-y-reverse: 0;\n  margin-top: calc(4px * calc(1 - var(--tw-space-y-reverse)));\n  margin-bottom: calc(4px * var(--tw-space-y-reverse));\n}"
    //     },
    //     {
    //       classValue: "space-x-1.5",
    //       expected:
    //         ".space-x-1.5{\n  --tw-space-x-reverse: 0;\n  margin-right: calc(6px * var(--tw-space-x-reverse));\n  margin-left: calc(6px * calc(1 - var(--tw-space-x-reverse)));\n}"
    //     },
    //     {
    //       classValue: "space-y-1.5",
    //       expected:
    //         ".space-y-1.5{\n  --tw-space-y-reverse: 0;\n  margin-top: calc(6px * calc(1 - var(--tw-space-y-reverse)));\n  margin-bottom: calc(6px * var(--tw-space-y-reverse));\n}"
    //     },
    //     {
    //       classValue: "space-x-2",
    //       expected:
    //         ".space-x-2{\n  --tw-space-x-reverse: 0;\n  margin-right: calc(8px * var(--tw-space-x-reverse));\n  margin-left: calc(8px * calc(1 - var(--tw-space-x-reverse)));\n}"
    //     },
    //     {
    //       classValue: "space-y-2",
    //       expected:
    //         ".space-y-2{\n  --tw-space-y-reverse: 0;\n  margin-top: calc(8px * calc(1 - var(--tw-space-y-reverse)));\n  margin-bottom: calc(8px * var(--tw-space-y-reverse));\n}"
    //     },
    //     {
    //       classValue: "space-x-96",
    //       expected:
    //         ".space-x-96{\n  --tw-space-x-reverse: 0;\n  margin-right: calc(384px * var(--tw-space-x-reverse));\n  margin-left: calc(384px * calc(1 - var(--tw-space-x-reverse)));\n}"
    //     },
    //     {
    //       classValue: "space-y-96",
    //       expected:
    //         ".space-y-96{\n  --tw-space-y-reverse: 0;\n  margin-top: calc(384px * calc(1 - var(--tw-space-y-reverse)));\n  margin-bottom: calc(384px * var(--tw-space-y-reverse));\n}"
    //     },
    //     {
    //       classValue: "space-x-px",
    //       expected:
    //         ".space-x-px{\n  --tw-space-x-reverse: 0;\n  margin-right: calc(1px * var(--tw-space-x-reverse));\n  margin-left: calc(1px * calc(1 - var(--tw-space-x-reverse)));\n}"
    //     },
    //     {
    //       classValue: "space-y-px",
    //       expected:
    //         ".space-y-px{\n  --tw-space-y-reverse: 0;\n  margin-top: calc(1px * calc(1 - var(--tw-space-y-reverse)));\n  margin-bottom: calc(1px * var(--tw-space-y-reverse));\n}"
    //     },
    //     {
    //       classValue: "space-y-reverse",
    //       expected: ".space-y-reverse{\n  --tw-space-y-reverse: 1;\n}"
    //     },
    //     {
    //       classValue: "space-x-reverse",
    //       expected: ".space-x-reverse{\n  --tw-space-x-reverse: 1;\n}"
    //     },
    //     {
    //       classValue: "space-x-[5px]",
    //       expected:
    //         ".space-x-\\[5px\\]{\n  --tw-space-x-reverse: 0;\n  margin-right: calc(5px * var(--tw-space-x-reverse));\n  margin-left: calc(5px * calc(1 - var(--tw-space-x-reverse)));\n}"
    //     },
    //     {
    //       classValue: "space-y-[5px]",
    //       expected:
  ...
  describe("Typography", () => {
    ...
    describe("Text Underline Offset", () => {
      it.each<{ classValue: string; expected: string }>([
        { classValue: "underline-offset-auto", expected: ".underline-offset-auto{\n  text-underline-offset: auto;\n}" },
        ...
        { classValue: "underline-offset-[3px]", expected: ".underline-offset-[3px]{\n  text-underline-offset: 3px;\n}" }
      ])(`tailwind($classValue)`, ({ classValue, expected }) => {
        expect(tailwind(classValue)).toBe(expected)
      })
    })
  ...
  describe("Borders", () => {
    describe("Border Radius", () => {
      ...
      it.each<{ classValue: string; expected: string }>([
        ...
        { classValue: "rounded-br-[10px]", expected: ".rounded-br-[10px]{\n  border-bottom-right-radius: 10px;\n}" },
    ...
    describe("Ring Offset Color", () => {
      it.each<{ classValue: string; expected: string }>([
        { classValue: "ring-offset-inherit", expected: ".ring-offset-inherit{\n  --tw-ring-offset-color: inherit;\n}" },
        {
  ...
  describe("Effects", () => {
    ...
    describe("Mix Blend Mode", () => {
      it.each<{ classValue: string; expected: string }>([
        ...
        { classValue: "mix-blend-color-dodge", expected: ".mix-blend-color-dodge{\n  mix-blend-mode: color-dodge;\n}" },
        ...
        { classValue: "mix-blend-plus-darker", expected: ".mix-blend-plus-darker{\n  mix-blend-mode: plus-darker;\n}" },
        {
  ...
  describe("Transforms", () => {
    describe("Scale", () => {
      it.each<{ classValue: string; expected: string }>([
        { classValue: "scale-0", expected: `.scale-0{\n  --tw-scale-x: 0;\n  --tw-scale-y: 0;\n  ${baseTransform}\n}` },
        ...
        { classValue: "scale-x-[1.7]", expected: `.scale-x-[1.7]{\n  --tw-scale-x: 1.7;\n  ${baseTransform}\n}` },
    ...
    describe("Rotate", () => {
      it.each<{ classValue: string; expected: string }>([
        ...
        { classValue: "rotate-[17deg]", expected: `.rotate-[17deg]{\n  --tw-rotate: 17deg;\n  ${baseTransform}\n}` }
      ])(`tailwind($classValue)`, ({ classValue, expected }) => {
        expect(tailwind(classValue)).toBe(expected)
      })
    })
    describe("Translate", () => {
      it.each<{ classValue: string; expected: string }>([
        ...
        { classValue: "translate-x-px", expected: `.translate-x-px{\n  --tw-translate-x: 1px;\n  ${baseTransform}\n}` },
        { classValue: "translate-y-px", expected: `.translate-y-px{\n  --tw-translate-y: 1px;\n  ${baseTransform}\n}` },
        {
    ...
    describe("Skew", () => {
      it.each<{ classValue: string; expected: string }>([
        ...
        { classValue: "skew-x-[17deg]", expected: `.skew-x-[17deg]{\n  --tw-skew-x: 17deg;\n  ${baseTransform}\n}` },
        { classValue: "skew-y-[17deg]", expected: `.skew-y-[17deg]{\n  --tw-skew-y: 17deg;\n  ${baseTransform}\n}` }
      ])(`tailwind($classValue)`, ({ classValue, expected }) => {
        expect(tailwind(classValue)).toBe(expected)
      })
    })
  ...
  describe("Interactivity", () => {
    ...
    describe("Will Change", () => {
      it.each<{ classValue: string; expected: string }>([
        ...
        { classValue: "will-change-[top,left]", expected: ".will-change-[top,left]{\n  will-change: top,left;\n}" }
      ])(`tailwind($classValue)`, ({ classValue, expected }) => {
        expect(tailwind(classValue)).toBe(expected)
      })
    })
